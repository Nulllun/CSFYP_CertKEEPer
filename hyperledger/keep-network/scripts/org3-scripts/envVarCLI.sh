...
PEER0_KEEP_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/keep.example.com/peers/peer0.keep.example.com/tls/ca.crt
...
setGlobals() {
  ...
  if [ $ORG -eq 1 ]; then
    ...
    CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_KEEP_CA
